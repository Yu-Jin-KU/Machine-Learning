...
need during this assignment. - \href{https://www.numpy.org}{numpy} is
the fundamental package for working with matrices in Python. -
\href{https://matplotlib.org}{matplotlib} is a famous library to plot
...
\PY{l+s+sd}{        }
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{c+c1}{\PYZsh{} return the following variables correctly}
...
\PY{l+s+sd}{        node\PYZus{}indices (list):     List containing the active indices. I.e, the samples being considered at this step.}
\PY{l+s+sd}{        feature (int):           Index of feature to split on}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Returns:}
\PY{l+s+sd}{        left\PYZus{}indices (list):     Indices with feature value == 1}
\PY{l+s+sd}{        right\PYZus{}indices (list):    Indices with feature value == 0}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{node\PYZus{}indices}\PY{p}{:}   
       \PY{k}{if} \PY{n}{X}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{n}{feature}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{:} \PY{c+c1}{\PYZsh{} code here to check if the value of X at that index for the feature is 1}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{CASE 1:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\PY{c+c1}{\PYZsh{} Visualize the split }
\PY{n}{generate\PYZus{}split\PYZus{}viz}\PY{p}{(}\PY{n}{root\PYZus{}indices}\PY{p}{,} \PY{n}{left\PYZus{}indices}\PY{p}{,} \PY{n}{right\PYZus{}indices}\PY{p}{,} \PY{n}{feature}\PY{p}{)}

\PY{n+nb}{print}\PY{p}{(}\PY{p}{)}

\PY{c+c1}{\PYZsh{} Case 2}

\PY{n}{root\PYZus{}indices\PYZus{}subset} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{]}
\PY{n}{left\PYZus{}indices}\PY{p}{,} \PY{n}{right\PYZus{}indices} \PY{o}{=} \PY{n}{split\PYZus{}dataset}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{root\PYZus{}indices\PYZus{}subset}\PY{p}{,} \PY{n}{feature}\PY{p}{)}

\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{CASE 2:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Left indices: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{left\PYZus{}indices}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Right indices: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{right\PYZus{}indices}\PY{p}{)}

\PY{c+c1}{\PYZsh{} Visualize the split }
\PY{n}{generate\PYZus{}split\PYZus{}viz}\PY{p}{(}\PY{n}{root\PYZus{}indices\PYZus{}subset}\PY{p}{,} \PY{n}{left\PYZus{}indices}\PY{p}{,} \PY{n}{right\PYZus{}indices}\PY{p}{,} \PY{n}{feature}\PY{p}{)}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}    
   ...
   \PY{c+c1}{\PYZsh{} code here to compute the proportion of examples at the left branch}
    \PY{n}{w\PYZus{}left} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}left}\PY{p}{)} \PY{o}{/} \PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}node}\PY{p}{)}

   \PY{c+c1}{\PYZsh{} code here to compute the proportion of examples at the right branch}
    \PY{n}{w\PYZus{}right} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}right}\PY{p}{)} \PY{o}{/} \PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}node}\PY{p}{)}

   \PY{c+c1}{\PYZsh{} code here to compute weighted entropy from the split using }
   ...
   \PY{c+c1}{\PYZsh{} code here to compute the information gain as the entropy at the node}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}    
   ...
   \PY{c+c1}{\PYZsh{} Iterate through all features}
    \PY{k}{for} \PY{n}{feature} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}features}\PY{p}{)}\PY{p}{:} 
       ...
       \PY{c+c1}{\PYZsh{} code here to compute the information gain from splitting on this feature}
       ...
       \PY{k}{if} \PY{n}{info\PYZus{}gain} \PY{o}{\PYZgt{}} \PY{n}{max\PYZus{}info\PYZus{}gain}\PY{p}{:}  
           \PY{c+c1}{\PYZsh{} code here to set the max\PYZus{}info\PYZus{}gain and best\PYZus{}feature}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}} 
    ...
    \PY{n}{tree}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{p}{(}\PY{n}{left\PYZus{}indices}\PY{p}{,} \PY{n}{right\PYZus{}indices}\PY{p}{,} \PY{n}{best\PYZus{}feature}\PY{p}{)}\PY{p}{)}
...
\PY{n}{generate\PYZus{}tree\PYZus{}viz}\PY{p}{(}\PY{n}{root\PYZus{}indices}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{tree}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
